      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-4">
          <div className="border border-gray-200 p-6 flex items-start gap-4">
            ...
            <div>
              <h2 className="font-bold text-text-primary mb-1">전화 상담</h2>
          ...
          <div className="border border-gray-200 p-6 flex items-start gap-4">
            ...
            <div>
              <h2 className="font-bold text-text-primary mb-1">카카오톡 상담</h2>
              <p className="text-gray-600 text-sm mb-2">
          ...
          <div className="border border-gray-200 p-6 flex items-start gap-4">
            ...
            <div>
              <h2 className="font-bold text-text-primary mb-1">이메일 문의</h2>
              <p className="text-gray-600 text-sm mb-2">
          ...
          <div className="border border-gray-200 p-6 flex items-start gap-4">
            ...
            <div>
              <h2 className="font-bold text-text-primary mb-1">찾아오시는 길</h2>
        ...
        <div className="border border-gray-200 p-6 md:p-8">
          <h2 className="text-[1.5rem] font-bold text-text-primary mb-6">온라인 상담 신청</h2>
          <form className="space-y-5">
            <div>
              ...
              <input
                type="text"
                id="name"
                className="w-full h-11 px-3 border border-gray-300 text-sm focus:outline-none focus:border-brand-blue"
            ...
            <div>
              ...
              <select
                id="grade"
                className="w-full h-11 px-3 border border-gray-300 text-sm focus:outline-none focus:border-brand-blue bg-white"
              >
            ...
            <div>
              ...
              <textarea
                id="message"
                rows={4}
                className="w-full px-3 py-2 border border-gray-300 text-sm focus:outline-none focus:border-brand-blue resize-none"
                placeholder="궁금한 내용을 자유롭게 작성해 주세요"
              />
            </div>
            <button
              type="submit"
              className="w-full h-16 bg-brand-blue text-white font-bold text-[1.375rem] rounded-full hover:bg-brand-blue-dark transition-colors"
            >
              상담 신청하기
            </button>
