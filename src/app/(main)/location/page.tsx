        ...
        <div className="space-y-6">
          ...
          <div className="border border-gray-200 p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h2 className="font-bold text-text-primary mb-1">주소</h2>
          ...
          <div className="border border-gray-200 p-6 space-y-5">
            <h2 className="font-bold text-text-primary">교통 안내</h2>
            ...
            <div className="flex items-start gap-3">
              <Bus size={18} className="text-brand-blue shrink-0 mt-0.5" />
              <div>
